...
function sanitizeTrackedErrors(input: unknown): TrackedError[] {
  ...
  return input
    ...
    .map((e) => ({
      ...
      how: typeof e.how === 'string' ? e.how : undefined,
      when: typeof e.when === 'string' ? e.when : undefined,
      whenNot: typeof e.whenNot === 'string' ? e.whenNot : undefined,
      checkExercise: typeof e.checkExercise === 'string' ? e.checkExercise : undefined,
