...
export function ChatScreen() {
  ...
  const sendMessage = useCallback(
      ...
      try {
        ...
        if (reply.correction) {
          ...
          const errorItem: TrackedError = {
            ...
            rule: reply.correction.rule,
            example: reply.correction.example,
            why: reply.correction.why,
            how: reply.correction.how,
            when: reply.correction.when,
            whenNot: reply.correction.whenNot,
            checkExercise: reply.correction.checkExercise,
    ...
    [addTrackedError, appendMessage, createMessage, isHydrated, isSending, mode, params.characterId, params.scenarioId, playAudio, progress.idiomaObjetivo, progress.nivelObjetivo, registerCharacterInteraction],
  );
