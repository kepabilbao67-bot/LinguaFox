...
export function ProgressScreen() {
  ...
  }, [allCourseLessons, progress.leccionesCompletadas, progress.nivelObjetivo, progress.spokenPhrasesCount]);
                ...
                {isExpanded && (
                  <View style={styles.expandedSection}>
                    ...
                    <View style={styles.competencyRow}>
                      ...
                      <Text style={styles.compVal}>{item.competencies.reading}%</Text>
                    </View>

                    <View style={styles.competencyRow}>
                      <Text style={styles.compLabel}>🎧 Escucha (Listening):</Text>
                      <Text style={styles.compVal}>{item.competencies.listening}%</Text>
                    </View>

                    <View style={styles.competencyRow}>
                      <Text style={styles.compLabel}>🧠 Vocabulario ({item.learnedWords}/{item.totalWords}):</Text>
                      <Text style={styles.compVal}>{item.competencies.vocabulary}%</Text>
                    </View>

                    <View style={styles.competencyRow}>
                      <Text style={styles.compLabel}>📐 Gramática aplicada:</Text>
                      <Text style={styles.compVal}>{item.competencies.grammar}%</Text>
                    </View>

                    <View style={styles.competencyRow}>
                      <Text style={styles.compLabel}>✍️ Escritura (Writing):</Text>
                      <Text style={styles.compVal}>{item.competencies.writing}%</Text>
                    </View>
